...
import '../styles/login.css'; // Or your login.css file
...
const Login = () => {
  ...
  // Add 'redirectPath' and 'setRedirectPath' to the variables
  // you are getting from the useAuth() hook.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (accessToken && user) {
        ...
        // This logic will now work because 'redirectPath' is defined.
        if (redirectPath) {
